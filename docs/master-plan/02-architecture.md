...
- Skill chain: `/spec-os-brainstorm` → `/spec-os-create` → `/spec-os-plan` → `/spec-os-implement` → `/spec-os-verify` → `/spec-os-doc`
...
|       |   +-- spec.md                <- technical spec (owned by /spec-os-create)
|       |   +-- spec-delta.md          <- formal spec evolution log (owned by /spec-os-create)
...
+-- .claude/
    ...
    +-- skills/
        ...
        |   +-- SKILL.md
        +-- spec-os-create/            <- /spec-os-create    owns spec.md + spec-delta.md
        |   +-- SKILL.md
        ...
        |   +-- SKILL.md
        +-- spec-os-prune/             <- /spec-os-prune     NEW
            +-- SKILL.md
```
